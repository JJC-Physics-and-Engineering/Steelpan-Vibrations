...
for region_1 in coords06241902:
    if region_1[0]>0 and region_1[0]<100 and region_1[1]>300 and region_1[1]<400 and region_1[3]!='0':
...
plt.figure(figsize=(20,10)).suptitle('Amplitude vs. Time for Region 1-Set 1902')
plt.xlabel('time (Frames)')
plt.ylabel('Amplitude (Fringes)')
...
time_2 = []
frng_2 = []
for region_2 in coords06241902:
    if region_2[0]>170 and region_2[0]<250 and region_2[1]>270 and region_2[1]<325 and region_2[3]!='0' and region_2[3] != '10':
...
plt.figure(figsize=(20,10)).suptitle('Amplitude vs. Time for Region 2-Set 1902')
plt.xlabel('time (Frames)')
plt.ylabel('Amplitude (Fringes)')
plt.xticks(range(0, 2000, 100))
plt.yticks(range(0,11,1))
...
time_3 = []
frng_3 = []
for region_3 in coords06241902:
    if region_3[0]>155 and region_3[0]<260 and region_3[1]>115 and region_3[1]<190 and region_3[3]!='0':
...
plt.figure(figsize=(20,10)).suptitle('Amplitude vs. Time for Region 3-Set 1902')
plt.xlabel('time (Frames)')
plt.ylabel('Amplitude (Fringes)')
plt.xticks(range(0, 2000, 100))
plt.yticks(range(0,11,1))
...
time_4 = []
frng_4 = []
for region_4 in coords06241902:
    if region_4[0]> (-30) and region_4[0]<67 and region_4[1]>115 and region_4[1]<200 and region_4[3]!='0':
...
plt.figure(figsize=(20,10)).suptitle('Amplitude vs. Time for Region 4-Set 1902')
plt.xlabel('time (Frames)')
plt.ylabel('Amplitude (Fringes)')
plt.xticks(range(0, 2000, 100))
plt.yticks(range(0,11,1))
...
time_5 = []
frng_5 = []
for region_5 in coords06241902:
    if region_5[0]>180 and region_5[0]<275 and region_5[1]>0 and region_5[1]<50 and region_5[3]!='0':
...
plt.figure(figsize=(20,10)).suptitle('Amplitude vs. Time for Region 5-Set 1902')
plt.xlabel('time (Frames)')
plt.ylabel('Amplitude (Fringes)')
plt.xticks(range(0, 2000, 100))
plt.yticks(range(0,11,1))
...
time_6 = []
frng_6 = []
for region_6 in coords06241902:
...
plt.figure(figsize=(20,10)).suptitle('Amplitude vs. Time for Region 6-Set 1902')
plt.xlabel('time (Frames)')
plt.ylabel('Amplitude (Fringes)')
plt.xticks(range(0, 2000, 100))
plt.yticks(range(0,11,1))
