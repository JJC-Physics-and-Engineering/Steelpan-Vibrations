...
for region_1 in coords06240910:
    if region_1[0]>30 and region_1[0]<165 and region_1[1]>300 and region_1[1]<400 and region_1[3]!='0':
...
time_2 = []
frng_2 = []
for region_2 in coords06240910:
    if region_2[0]>165 and region_2[0]<250 and region_2[1]>300 and region_2[1]<400 and region_2[3]!='0':
...
time_3 = []
frng_3 = []
for region_3 in coords06240910:
    if region_3[0]>270 and region_3[0]<380 and region_3[1]>260 and region_3[1]<325 and region_3[3]!='0':
...
time_4 = []
frng_4 = []
for region_4 in coords06240910:
    if region_4[0]>290 and region_4[0]<400 and region_4[1]>100 and region_4[1]<200 and region_4[3]!='0':
...
time_5 = []
frng_5 = []
for region_5 in coords06240910:
    if region_5[0]>65 and region_5[0]<150 and region_5[1]>117 and region_5[1]<190 and region_5[3]!='0':
...
time_6 = []
frng_6 = []
for region_6 in coords06240910:
    if region_6[0] > 0 and region_6[0] < 200 and region_6[1] > 100 and region_6[1] < 250 and region_6[3] != '0':
