...
for region_1 in coords06240909:
    if region_1[0]>65 and region_1[0]<170 and region_1[1]>80 and region_1[1]<155 and region_1[3]!='0':
...
time_2 = []
frng_2 = []
for region_2 in coords06240909:
    if region_2[0]>265 and region_2[0]<335 and region_2[1]>95 and region_2[1]<150 and region_2[3]!='0':
...
time_3 = []
frng_3 = []
for region_3 in coords06240909:
    if region_3[0]>90 and region_3[0]<180 and region_3[1]>285 and region_3[1]<360 and region_3[3]!='0':
...
time_4 = []
frng_4 = []
for region_4 in coords06240909:
    if region_4[0]>279 and region_4[0]<333 and region_4[1]>30 and region_4[1]<85 and region_4[3]!='0':
...
time_5 = []
frng_5 = []
for region_5 in coords06240909:
    if region_5[0]>270 and region_5[0]<315 and region_5[1]>160 and region_5[1]<230 and region_5[3]!='0':
...
time_6 = []
frng_6 = []
for region_6 in coords06240909:
    if region_6[0] > 150 and region_6[0] < 200 and region_6[1] > 350 and region_6[1] < 400 and region_6[3] != '0':
