...
with open("steelpan-vibrations-classifications.csv") as csvfile:
    ...
    for row in csvrow:
        ...
        if z == "Counting Fringes":
            ...
            cas = re.split('"|\{|\}|\[|\]|:|T\d'
                           '|task|T0|,|task|_|label|\*\*How many antinode regions do you see\?\*\*\\nClick \\""Need some help\\"" if you are unsure\.|value'
            ...
            if l_cas == 1:
                ...
                if subject_id == '2883463':
                    coords2883463.append(coords1)
...
df_to_center_plt(coords2883463)
